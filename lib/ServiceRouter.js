...
function requestWithDigest(url, res, username, password) {
  requestWithAuthentication(url, res, username, password, true);
}

function requestWithBasic(url, res, username, password) {
  requestWithAuthentication(url, res, username, password, false);
}

function requestWithAuthentication(url, res, username, password, isDigest) {
  var options = {
    uri: url,
    auth: {
      user: username,
